...
# Monkey patch for JAX compatibility
import jax.tree_util
if not hasattr(jax, 'tree'):
    jax.tree = jax.tree_util
# Add tree_map alias for backward compatibility
...
# Instead of importing LogWrapper from purejaxrl, we define it here. purejaxrl is not installed in the environment.
class LogWrapper:
...
class ScannedRNN(nn.Module):
    ...
    def __call__(self, carry, x):
        ...
        new_rnn_state, y = nn.GRUCell(features=128)(rnn_state, ins)
